...
package LPU_helperPKG is
  ...
  type state_t is (START, FETCHWAIT, FETCH1, FETCH2, EX1, LDST, ERROR);
...
--  -- define an enum to represemt the different sequencer states
--  type sequencer_states is(
--    START, -- idle state
--    FETCHWAIT, -- wait until memory is ready for a transaction
--    FETCH1, -- read instruction from memory
--    FECTH2, -- wait until intruction has been read from memory
--    EX1, -- execute instruction
--    LDST, -- loads from or stores to memory
--    ERROR
--    );
...
end package LPU_helperPKG;

package body LPU_helperPKG is
...
end package body LPU_helperPKG;