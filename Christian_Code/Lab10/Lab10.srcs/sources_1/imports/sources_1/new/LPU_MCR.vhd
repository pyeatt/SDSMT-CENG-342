...
entity LPU_MCR is
    port(
        MCRin: in std_logic_vector(3 downto 0); -- Data bus to load in a new value to the MCR
        MCRout: out std_logic_vector(3 downto 0); -- Data bus to output the current value of the MCR
