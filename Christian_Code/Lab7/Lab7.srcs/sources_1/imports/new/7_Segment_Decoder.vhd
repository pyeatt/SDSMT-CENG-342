...
begin
    ...
    sseg(0) <= ( (not hex(3)) and (not hex(2)) and (not hex(1)) and hex(0) ) or
    ...
    sseg(1) <= ( (not hex(3)) and hex(2) and (not hex(1)) and hex(0) ) or
                 ( hex(2) and hex(1) and (not hex(0)) ) or
                 ( hex(3) and hex(1) and hex(0) ) or
                 ( hex(3) and hex(2) and (not hex(0)) );
    sseg(2) <= ( (not hex(3)) and (not hex(2)) and hex(1) and (not hex(0)) ) or
