...
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS18 } [get_ports { UART_CTS }]; #IO_L12N_T1_MRCC_35 Sch=uart_cts my output
#set_property -dict { PACKAGE_PIN E5    IOSTANDARD LVCMOS18 } [get_ports { UART_RTS }]; #IO_L5N_T0_AD13N_35 Sch=uart_rts my input
...
create_clock -period 20.000 -name VIRTUAL_clk_50_clk_wiz_0 -waveform {0.000 10.000}
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -min -add_delay 0.000 [get_ports {buttons[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -max -add_delay 2.000 [get_ports {buttons[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports {buttons[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 2.000 [get_ports {buttons[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -min -add_delay 0.000 [get_ports {switches[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -max -add_delay 2.000 [get_ports {switches[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports {switches[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 2.000 [get_ports {switches[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -min -add_delay 0.000 [get_ports RXD]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -max -add_delay 2.000 [get_ports RXD]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports RXD]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 2.000 [get_ports RXD]

set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports reset]
set_input_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 10.000 [get_ports reset]

# set_input_delay -clock [get_clocks sys_clk_pin] -min -add_delay 0.000 [get_ports reset]
# set_input_delay -clock [get_clocks sys_clk_pin] -max -add_delay 10.00 [get_ports reset]

#set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -min -add_delay 2.000 [get_ports TXD]
#set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -clock_fall -max -add_delay 2.000 [get_ports TXD]
#set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 2.000 [get_ports TXD]
#set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 2.000 [get_ports TXD]

set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] 8.000 [get_ports TXD]

set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports {leds[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 1.000 [get_ports {leds[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports {rgb_leds[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 1.000 [get_ports {rgb_leds[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports {sseg[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 1.000 [get_ports {sseg[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -min -add_delay 0.000 [get_ports {sseg_an[*]}]
set_output_delay -clock [get_clocks VIRTUAL_clk_50_clk_wiz_0] -max -add_delay 1.000 [get_ports {sseg_an[*]}]



# set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 0.000 [get_ports {leds[*]}]
# set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {leds[*]}]
# set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 0.000 [get_ports {rgb_leds[*]}]
# set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {rgb_leds[*]}]
# set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 0.000 [get_ports {sseg[*]}]
# set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {sseg[*]}]
# set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 0.000 [get_ports {sseg_an[*]}]
